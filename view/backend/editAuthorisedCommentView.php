...
<article>
    <div class="col-lg-8 col-md-10 mx-auto">
        ...
        <h3>
            <?= htmlspecialchars($autoComments['author']); ?>

        </h3>
        <p class="text-center">
            <?= nl2br($autoComments['email']) ?>
        </p>


        <p class="text-center">
            <?= nl2br($autoComments['comment']); ?>
        </p>
        ...
        <div id="answer">
            ...
            <p>
                ...
                <?= nl2br($autoComments['answer']);?>


            </p>

            <h3>Répondre</h3>
            <form id="contactForm" name="sentMessage" action="index.php?action=addAnswer&amp;id=<?= $autoComments['id'] ?>" method="post">
